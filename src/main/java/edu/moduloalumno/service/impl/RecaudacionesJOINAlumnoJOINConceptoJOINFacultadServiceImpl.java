...
public class RecaudacionesJOINAlumnoJOINConceptoJOINFacultadServiceImpl implements IRecaudacionesJOINAlumnoJOINConceptoJOINFacultadService {
	...
	@Override //nuevo
	public boolean updaterecaudacionesJOINAlumnoJOINConceptoJOINFacultad(Integer id_concepto,String moneda,Date fecha,String recibo,int ciclo,int idRec, int importe){
		logger.info("Facultad Service"+fecha+" "+" "+recibo+" "+ciclo +" "+idRec);
		return recaudacionesJOINAlumnoJOINConceptoJOINFacultadDAO.updateRecaudacionesJOINAlumnoJOINConceptoJOINFacultad(id_concepto,moneda,fecha,recibo,ciclo,idRec, importe);
