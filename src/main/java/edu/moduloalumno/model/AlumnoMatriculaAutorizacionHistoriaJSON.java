...
public class AlumnoMatriculaAutorizacionHistoriaJSON {
    ...
    public AlumnoMatriculaAutorizacionHistoriaJSON() {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AlumnoMatriculaAutorizacionHistoriaJSON other = (AlumnoMatriculaAutorizacionHistoriaJSON) obj;
        if (cod_alumno == null) {
