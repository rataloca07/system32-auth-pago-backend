...
public class conceptoDescuento implements Serializable {
    ...
    public conceptoDescuento(Integer id_programa_ciclo, /*Integer ciclo,*/ Integer id_concepto, String concepto, String descripcion_min, Integer credito, Integer importe, float descuento, float importe_final, Integer cuotas) {
