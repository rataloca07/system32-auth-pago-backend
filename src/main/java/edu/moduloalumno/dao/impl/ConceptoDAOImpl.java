...
import edu.moduloalumno.rowmapper.UbicacionsRowMapper;
import edu.moduloalumno.rowmapper.CuentasRowMapper;
...
public class ConceptoDAOImpl implements IConceptoDAO {
	...
	@Override
	public List<Ubicacions> getAllUbicacion() {
		String sql = "select * from ubicacion;";
		RowMapper<Ubicacions> rowMapper = new UbicacionsRowMapper();
		return this.jdbcTemplate.query(sql, rowMapper);
	}
	...
	public List<Cuentas> getAllCuentas() {
		...
		RowMapper<Cuentas> rowMapper = new CuentasRowMapper();
		return this.jdbcTemplate.query(sql, rowMapper);
	}
