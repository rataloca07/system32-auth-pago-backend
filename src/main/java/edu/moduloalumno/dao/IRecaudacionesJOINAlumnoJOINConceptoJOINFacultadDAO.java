...
public interface IRecaudacionesJOINAlumnoJOINConceptoJOINFacultadDAO {
	...
	boolean updateRecaudacionesJOINAlumnoJOINConceptoJOINFacultad(Integer id_concepto,String moneda,Date fecha, String recibo,int ciclo,int idRec, int importe);
